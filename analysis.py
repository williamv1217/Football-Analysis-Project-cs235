...
def analysis():
    ...
    print('-----------------------------------')
    print('set piece goals are from free kicks where there is not a direct goal (assist to another player), or penalties')
    print('e.g.: a freekick is headed in, a penalty')
